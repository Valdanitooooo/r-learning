---
title: "nycflights13数据集探索 - dplyr解决方案"
output: html_notebook
---

### 前言

这是一篇天关于dplyr包的使用练习，题目来自《R语言数据高效处理指南》(黄天元 著)中的第8章-航班飞行数据演练里面的第一节8.1-nycflights13数据集探索。
...
flights %>%
  ...
  summarise(flights_count = n(),
            tailum_count = n_distinct(tailnum))
```
